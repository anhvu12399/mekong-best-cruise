  ...
  return (
    <main className="min-h-screen bg-[#f7f4ef]">
      <section className="relative w-full h-screen overflow-hidden">
        <Image src="/images/dest_cambodia_hero.jpg" alt="Angkor Wat at sunrise, Cambodia" fill priority className="object-cover" sizes="100vw" />
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <Image src="/images/dest_cambodia_hero.jpg" alt="Cambodia" fill className="object-cover object-center" sizes="100vw" />
