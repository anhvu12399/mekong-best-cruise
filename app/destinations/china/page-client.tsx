...
const experiences = [
  {
    label: "The Gorge",
    title: "Tiger Leaping Gorge at the Narrowing",
    body: "The canyon walls are over three thousand meters above your head. The river is two hundred meters below you, white and violent, crashing through a gap so narrow a tiger allegedly leaped across it — hence the name. You're on the high trail, a stone path cut directly into the cliff face, with nothing between you and the drop except a low stone wall and your own careful footing. The scale of it silences everything. Your guide, who has walked this trail perhaps two hundred times, still stops at the same viewpoint every time. He says he can't help it. You understand completely.",
    image: "/images/china_exp_1.avif",
    tag: "High Trail · Tiger Leaping Gorge, Yunnan",
  },
  {
    label: "Tea Country",
    title: "Lijiang and the Tea Horse Road",
    body: "The old town of Lijiang has been continuously occupied for over eight hundred years and sits in a valley at 2,400 meters, with snow peaks visible from the central market square on clear days. The Tea Horse Road ran through here — merchants with mule trains carrying compressed tea bricks north to Tibet, bringing horses south in return. You walk the cobblestone lanes of the old town in the early morning before the tourist groups arrive. A grandmother sweeps her doorstep in the traditional Naxi dress. The smell of roasting tea comes from a shop that has been roasting it for three generations.",
    image: "/images/china_exp_2.avif",
    tag: "Dawn walk · Lijiang Old Town, Yunnan",
  },
  {
    label: "Source Country",
    title: "The River Before the River",
    body: "Near Shangri-La (Zhongdian), the upper Mekong — called the Lancang here — is barely a river at all. A cold, fast-moving stream descending from high alpine pastures, threading between yak herds and prayer-flag-draped monasteries perched on ridges. You drive a switchback road to a viewpoint where the valley spreads below you and the young river is visible from above, silver against the brown earth. Your guide points upstream, toward where it comes from — the Tibetan Plateau, another two days north by bad road. 'That's where it begins,' he says. 'Everything downstream is because of that.'",
    image: "/images/china_exp_3.avif",
  ...
  return (
    <main className="min-h-screen bg-[#f7f4ef]">
      ...
      <section className="relative w-full h-screen overflow-hidden">
        <Image
          src="/images/dest_china_hero.avif"
          alt="Tiger Leaping Gorge, Yunnan China"
          fill
          priority
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-16 lg:pb-24 px-8 lg:px-16 z-10">
          ...
          <h1 className={`text-white text-5xl md:text-7xl lg:text-[6rem] leading-[0.95] mb-6 max-w-4xl ${playfair.className}`}>
            The River<br />
            <em className="not-italic text-white/80">Before the River</em>
          </h1>
          <div className="flex items-end justify-between">
            <p className="text-white/75 text-lg md:text-xl font-serif max-w-xl leading-relaxed">
              The Mekong is born in China's Yunnan — as the Lancang Jiang, carving through gorges deeper than the Grand Canyon before becoming the river of Southeast Asia.
            </p>
            <Link
      ...
      <section className="max-w-3xl mx-auto px-6 lg:px-8 py-24 md:py-32">
        ...
        <div className="font-serif text-navy/80 text-xl md:text-2xl leading-[1.8] space-y-6">
          <p>
            <span className="float-left text-8xl leading-[0.75] mr-4 text-navy font-bold">T</span>he Mekong doesn't begin in Vietnam, or Cambodia, or any of the countries most travelers associate with it. It begins on the Tibetan Plateau at over 5,000 meters elevation, a cold trickle in an alpine landscape of yaks and prayer flags and absolute stillness. By the time it reaches Yunnan Province in southern China, it has become the Lancang Jiang — the Turbulent River — a powerful, fast-moving force cutting through some of the deepest gorges in the world before it crosses the border and becomes the Mekong of the guidebooks.
          </p>
          <p>
            Yunnan is China's most diverse and, for many travelers, most beautiful province. Home to twenty-five of China's fifty-five recognized ethnic minorities, it sits at the crossroads of China, Southeast Asia, and the Tibetan world — culturally, geographically, gastronomically. The food here is nothing like the Chinese food you've eaten anywhere else: wild mushrooms from the mountains, goat cheese unique to the Naxi people, ham cured for years in the cool highland air, the local puer tea pressed into cakes and aged for decades.
          </p>
          <p>
            Tiger Leaping Gorge is the dramatic center of Yunnan's upper Mekong experience — a canyon so deep and so vertical that standing on the high trail feels less like hiking and more like a geological event you're witnessing in real time. The walls rise over three kilometers. The river at the bottom is invisible except for the sound. When it comes into view at the narrowing — the tiger's leap — it is white and violent and indifferent to the considerable human drama that has unfolded on its banks over the centuries.
          </p>
          <p>
            The old Tea Horse Road towns — Lijiang, Dali, Shangri-La — provide the human counterpoint. These were trading posts on one of Asia's great overland routes, where merchants from the lowlands exchanged compressed tea for Tibetan horses, and where cultures mixed for centuries in the cobblestone plazas and caravanserai that still stand. Walking Lijiang's old town in the early morning, before the tour groups arrive, you find yourself in a place that is simultaneously ancient and alive, preserved and genuinely inhabited.
          </p>
          <p>
            To come to Yunnan is to find the beginning of something that doesn't end until the Mekong enters the South China Sea, five thousand kilometers south. Standing at Tiger Leaping Gorge and watching the river descend, you understand that everything you've seen or will see downstream started here — this cold, powerful, indifferent force that has been flowing in the same direction for longer than any human civilization on its banks.
          </p>
        </div>
      </section>
      ...
      <section className="bg-navy py-20 px-8 text-center">
        <p className={`text-white text-2xl md:text-4xl lg:text-5xl leading-tight max-w-4xl mx-auto font-serif italic`}>
          "The Mekong in Yunnan is not yet patient. It is still young. It will learn patience when it reaches the delta. For now, it simply descends."
        </p>
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <Image src="/images/dest_china.avif" alt="China Mekong Gorge" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <div>
            ...
            <p className={`text-white text-3xl md:text-5xl max-w-3xl mx-auto leading-tight ${playfair.className}`}>
              "This is where five thousand kilometers begin. Everything downstream is an echo of this gorge."
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16 lg:mb-24">
            ...
            <p className="max-w-2xl mx-auto text-navy/70 text-base md:text-lg leading-relaxed font-serif">
              Follow the ancient tea-horse caravan roads or design a fully custom private routing.
            </p>
          </div>
      ...
      <section className="py-24 bg-[#ede9e2]/30 border-t border-[#e0d9ce]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16 lg:mb-24">
            ...
            <div className="w-16 h-px bg-[#c9a962] mx-auto mb-8" />
            <p className="max-w-2xl mx-auto text-navy/70 text-base md:text-lg leading-relaxed font-serif">
              Step aboard ships that redefine river travel. Explore our curated select fleet of premium vessels for regional luxury extensions.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-x-10 gap-y-8">
                {[
                  ...
                  { label: "Entry", value: "Chinese visa required (apply in advance)" },
                  { label: "Currency", value: "Chinese Yuan (CNY)" },
                  { label: "Language", value: "Mandarin · Minority languages in Yunnan" },
                  { label: "Key Destinations", value: "Lijiang, Dali, Tiger Leaping Gorge" },
                  { label: "Journey Length", value: "7 to 14 days for Yunnan" },
                ].map((item) => (
                  <div key={item.label}>
            ...
            <div className="bg-[#f7f4ef] p-10 lg:p-12 flex flex-col justify-between">
              <div>
                ...
                <p className={`text-3xl text-navy mb-6 leading-tight ${playfair.className}`}>
                  Gorges, ancient towns, and the river before it becomes the Mekong.
                </p>
                <p className="font-serif text-navy/65 leading-relaxed mb-8">
                  We design Yunnan itineraries that combine the dramatic upper gorge landscapes with the cultural depth of the tea-horse road towns — and for those who want the full river story, we can arrange a journey that follows the Mekong from China all the way to the South China Sea.
                </p>
              </div>
              <Link
                href="/plan-your-journey"
