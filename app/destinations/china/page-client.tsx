  ...
  return (
    <main className="min-h-screen bg-[#f7f4ef]">
      <section className="relative w-full h-screen overflow-hidden">
        <Image src="/images/dest_china_hero.jpg" alt="Tiger Leaping Gorge, Yunnan China" fill priority className="object-cover" sizes="100vw" />
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <Image src="/images/dest_china_hero.jpg" alt="China Mekong gorge" fill className="object-cover" sizes="100vw" />
