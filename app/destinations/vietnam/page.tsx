...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Vietnam luxury boat charter',
    'My Tho river cruise',
    'Sa Dec floating market',
    'Chau Doc river cruise',
    'Vietnam slow travel',
    'Mekong Delta homestay cruise',
    'authentic Vietnam river experience',
    'Mekong delta luxury sampan',
    'Vietnam eco tourism cruise'
],
