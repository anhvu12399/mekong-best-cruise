export const destinationsData = [
  ...
  },
  {
    ...
    defines: [
      ...
      "Traditional folk music (Don Ca Tai Tu)",
      "Dragon, Unicorn, Turtle, and Phoenix islands",
      "Serene palm-shaded waterways"
    ],
    story: [
      "Here the Mekong splits into several streams of the delta, numerous orchards and small canals, surrounded by lush greenery and coconut palm plantations. Transition into the delta region is so smooth that travelers do not have difficulty noticing this transition. Water ceases to serve as the limit of the earth's surface. To the contrary, water now plays a major role in shaping the landscape.",
  ...
  },
  {
    ...
    defines: [
      ...
      "Vast ornamental flower villages",
      "Faded French-colonial villas",
      "Quiet, deeply traditional river life"
    ],
    story: [
      "The presence of the river in the case of Sa Dec is much calmer and more subtle than in other Mekong towns. Fragments of houses belonging to merchants tell us about a period of active trade on the Mekong. Old facades, shaded alleyways and gardens soften the look of a city whose identity is associated with its historical heritage. The river presence is strong enough, as evidenced by numerous canals that extend into orchards and narrow water bodies.",
  ...
  },
  {
    ...
    defines: [
      ...
      "Jungle-swallowed Ta Prohm",
      "Vibrant artisan night markets"
    ],
    story: [
      "For many, Siem Reap represents the spiritual culmination of the Mekong journey, even if the great river itself defers to the immense Tonlé Sap Lake. The city is a gateway to the ancient Khmer empire, where time is measured not in hours, but in epochs etched into the stone faces of Bayon.",
